...
export default function PricingPage() {
  const plans = [
    ...
    },
    {
      ...
      price: "$29",
      period: "per month",
      description: "Comprehensive health analytics for serious health enthusiasts",
      features: [
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 max-w-7xl text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              Choose Your
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"> Health Journey</span>
            </h1>
            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
              Transform your lab results into actionable insights with our AI-powered health analytics platform. 
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {plans.map((plan) => (
                <Card 
                  key={plan.name} 
                  className={`relative ${plan.popular ? 'border-blue-500 shadow-2xl scale-105' : 'border-gray-200'}`}
                >
                  {plan.popular && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Our advanced Multi Medical Model technology analyzes your results with clinical-grade precision
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Get personalized recommendations and track your progress with easy-to-understand reports
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600">
                  Yes! We offer a 14-day free trial with no credit card required. You can explore all features of the Basic plan during your trial period.
                </p>
              </div>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2">Is my health data secure?</h3>
                <p className="text-gray-600">
                  Yes, we use bank-level encryption and are HIPAA compliant. Your data is stored securely and never shared without your explicit consent.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We support PDF lab reports from most major labs, as well as CSV and Excel files. Our AI can process most standard lab report formats.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Join thousands of users who are already making data-driven health decisions
            </p>
